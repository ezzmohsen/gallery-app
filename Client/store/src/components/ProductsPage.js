                ...
                {filteredProducts.map(product => (
                    ...
                    >
                        <div 
                            ...
                            onMouseEnter={(e) => {
                                e.currentTarget.querySelector('.product-image').style.transform = styles.productImageHover.transform;
                                e.currentTarget.querySelector('.icon-overlay').style.opacity = styles.iconOverlayHover.opacity;
                            }}
                            onMouseLeave={(e) => {
                                e.currentTarget.querySelector('.product-image').style.transform = '';
                            ...
                            >
                                <FaEye 
                                    ...
                                    onMouseEnter={(e) => {
                                        ...
                                        e.currentTarget.style.transform = styles.iconHover.transform;
                                    }}
                                    onMouseLeave={(e) => {
